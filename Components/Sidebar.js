...
export default function Sidebar({ toggle, setToggle }) {
  return (
    <div
      className={`fixed flex flex-col items-center gap-10 top-[75px] right-0 w-full bg-dark p-7 h-full z-40 ease-in-out duration-500 ${
    ...
    >
      ...
      <svg
        ...
        width="50px"
        height="50px"
        className="abs-center top-[78%] opacity-10 w-1/4 h-1/4"
      >
